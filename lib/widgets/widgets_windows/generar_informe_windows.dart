...
class GenerarInformeWindows extends ConsumerStatefulWidget {
  const GenerarInformeWindows({
    super.key,
  ...
  ConsumerState<ConsumerStatefulWidget> createState() {
    return _GenerarInformeWindowsState();
  }
}

class _GenerarInformeWindowsState extends ConsumerState<GenerarInformeWindows> {
  ...
  //metodo para obtener los partes y sus estadisticas
  void obtenerPartes(WidgetRef ref) async {
    ...
    //obtenemos el mes actual en formato literario
    ...
    //sacamos la estadistica de los servicios por perdida de comunicacion
    serviciosPerdidaComunicacion =
        ref
            .read(informeControllerProvider.notifier)
            .serviciosPerdidaComunicacion();
    //sacamos la estadistica de los servicios por intrusion
    serviciosIntrusion =
        ref.read(informeControllerProvider.notifier).serviciosIntrusion();
    //sacamos la estadistica de los servicios por incendio
    serviciosIncendio =
