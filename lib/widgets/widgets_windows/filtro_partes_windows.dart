...
class FiltroPartesWindows extends ConsumerStatefulWidget {
  const FiltroPartesWindows({super.key});

  @override
  ConsumerState<FiltroPartesWindows> createState() {
    return _FiltroPartesWindowsState();
  }
}

class _FiltroPartesWindowsState extends ConsumerState<FiltroPartesWindows> {
                    ...
                    Row(
                      ...
                      children: [
                        SizedBox(
                          width: 180,
                          child: TextField(
                            cursorColor: const Color.fromARGB(186, 2, 28, 114),
