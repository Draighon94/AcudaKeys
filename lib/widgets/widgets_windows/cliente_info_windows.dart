...
class ClienteInfoWindows extends ConsumerStatefulWidget {
  const ClienteInfoWindows({super.key, required this.cliente});

  final Cliente cliente;

  @override
  ConsumerState<ClienteInfoWindows> createState() {
    return _ClienteInfoState();
  }
}

class _ClienteInfoState extends ConsumerState<ClienteInfoWindows> {
  _ClienteInfoState();
